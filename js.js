...
let snakes = new Map([
  ...
  let images = ["https://i.postimg.cc/pVFkVtTd/dice-01.png",
  "https://i.postimg.cc/Gmcjj8jB/dice-02.png",
  "https://i.postimg.cc/ncKk7Yqb/dice-03.png",
  "https://i.postimg.cc/cLXBkxDF/dice-04.png",
  "https://i.postimg.cc/NfvD5P9k/dice-05.png",
  "https://i.postimg.cc/mrkN0vJB/dice-06.png"]
...
let index=0
            ...
            snakes.forEach(function(value, key) {
              ...
              image.setAttribute("src", "https://i.postimg.cc/bvhL2SSF/Snake-clipart-5-2.png")
            ...
            index=0
                        ...
                        ladder.forEach(function(value, key) {
                          console.log(key + " = " + value);
                          var image = document.createElement("img"); 
                          image.setAttribute("src", "https://i.postimg.cc/9QTJMY07/ladder.png")
